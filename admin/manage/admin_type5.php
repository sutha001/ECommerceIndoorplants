    ...
    ?>
        <div class="area_all" style="background-color: black;">
            <div class="menu_editor">
                ...
                <div class="row_edit">
                    <a
                     href="../admin_manage_user.php" class="btn btn-dark" style="background-color: #4f4f4f;">การจัดการผู้ใช้</a>
                </div>
                <div class="row_edit">
                ...
                <div class="container">
                    <div class="info_right">
                        ...
                        <div style="margin: 3% 0%;">
                            ...
                            <a class="btn btn-dark" style="background-color: #4d4d4d;" href="admin_type1.php">ดูดสารพิษ</a>
                            ...
                            <a class="btn btn-dark" style="background-color: #ffffff; color:#1b221b;" href="admin_type5.php">ฟอกอากาศ</a>
                        </div>
                        <table>
                            <thead>
                                <tr>
